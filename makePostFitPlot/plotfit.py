...
for dirName in ["shapes_prefit",  "shapes_fit_b"]:#, "shapes_fit_s"]:
    ...
    for bdtbin in ["FitCRPre"]:

        #fin = r.TFile("ttbar/fitDiagnostics"+bdtbin+".root", "READ")
        fin = r.TFile("FitCR/fitDiagnostics"+bdtbin+".root", "READ")
        h1_sig = []
        h1_bkg = []
        h1_data = None
