...
parser.add_argument('-o' , '--output_dir'             , dest='output_dir'      , help='output dir path'                        , default='/storage/af/user/nlu/work/HH/CMSSW_9_4_2/src/HHLooper_sysTest/output_plot')
