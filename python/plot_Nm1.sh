...
python plot.py -OP -i ../hists/${TAG}/ Nm1FatJet1SDMassLeft__FatJet1_msoftdrop -s 100 -b 0.85
python plot.py -OP -i ../hists/${TAG}/ Nm1FatJet1SDMassRight__FatJet1_msoftdrop -s 100 -b 0.85 -R
python plot.py -OP -i ../hists/${TAG}/ Nm1FatJet1Pt__FatJet1_pt -s 100 -b 0.85
...
python plot.py -OP -i ../hists/${TAG}/ Nm1FatJet2Pt__FatJet2_pt -s 100 -b 0.85
python plot.py -OP -i ../hists/${TAG}/ Nm1FatJet2DDB__FatJet2_btagDDBvL -s 100 -b 0.85
#python plot.py -OP -i ../hists/${TAG}/ Nm1SR2FatJet2DDB__FatJet2_btagDDBvL -s 100 -b 0.85
python plot.py -OP -i ../hists/${TAG}/ Nm1SR3FatJet2DDB__FatJet2_btagDDBvL -s 100 -b 0.85
