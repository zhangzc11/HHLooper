...
python plot.py -OP -i ../hists/${TAG}/ Nm1SR2FatJet1DDB__FatJet1_btagDDBvL -s 100 -b 1.5
python plot.py -OP -i ../hists/${TAG}/ Nm1SR3FatJet1DDB__FatJet1_btagDDBvL -s 100 -b 1.5
...
python plot.py -OP -i ../hists/${TAG}/ Nm1SR2FatJet2DDB__FatJet2_btagDDBvL -s 100 -b 1.5
python plot.py -OP -i ../hists/${TAG}/ Nm1SR3FatJet2DDB__FatJet2_btagDDBvL -s 100 -b 1.5
