...
class hhtree{
 ...
 protected:
   ...
   vector<float> *top_pt_;
   TBranch *top_pt_branch;
   bool top_pt_isLoaded;
   vector<float> *top_eta_;
 ...
 public:
   ...
   const vector<float> &ph_parent_id();
   const vector<float> &m_el_pt();
   const vector<float> &m_el_eta();
   const vector<float> &m_el_phi();
   const vector<float> &m_el_E();
   const vector<float> &m_el_pdg();
   const vector<float> &m_mu_pt();
   const vector<float> &m_mu_eta();
   const vector<float> &m_mu_phi();
   const vector<float> &m_mu_E();
   const vector<float> &m_mu_pdg();
   const vector<float> &tau_pt();
   const vector<float> &tau_eta();
   const vector<float> &top_pt();
   const vector<float> &top_eta();
   const vector<float> &b_pt();
   const vector<float> &b_eta();
   const vector<float> &b_phi();
   const vector<float> &m_jet_pt();
   const vector<float> &m_jet_eta();
   const vector<float> &m_jet_phi();
   const vector<float> &m_jet_m();
   const vector<float> &m_jet_btag70();
   const vector<float> &m_jet_btag77();
   const vector<float> &m_jet_btag60();
   const vector<float> &m_jet_btag85();
   const vector<float> &jet_AK4_b_tag();
   const vector<float> &susy_m();
   const vector<float> &susy_pt();
   const vector<float> &susy_eta();
   const vector<float> &susy_phi();
   const vector<float> &susy_pdg();
   const int &m_njet();
